...
- [X] **Bundled using Vite** - Succesfully bundled and deployed webpage.
- [X] **Components** - have six components: app, login, characterBuilder, communityBuilds, savedBuilds, and about. All these component contain placeholder for additional things to be implemented.
- [X] **Router** - Can succesfully route from login to characterBuilder as well as routing from header. Also can successfully route from savedBuilds and community builds to characterBuilder
